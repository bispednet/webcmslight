...
<div class="space-y-10">
    ...
    <div class="info-card info-card--accent" data-animate>
        ...
        <p class="text-sm" style="color:var(--c-muted)">Lo storico richieste, i documenti e la gestione ordini sono in arrivo. Per assistenza immediata scrivi a <a href="mailto:info@bisped.net" style="color:var(--bisped-red)">info@bisped.net</a> o chiama il <a href="tel:+390565200000" style="color:var(--bisped-red)">0565 200000</a>.</p>
    </div>
