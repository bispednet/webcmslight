...
$email   = $settings['contact_email']   ?? 'info@bisped.net';
        ...
        <aside class="space-y-4">
            ...
            <div class="info-card">
                ...
                <div class="flex flex-col gap-2">
                    <a href="https://wa.me/390565200000" target="_blank" rel="noopener"
    ...
    <section class="grid gap-6 md:grid-cols-2 items-center" data-animate>
        ...
        <div class="info-card">
            ...
            <div class="flex flex-wrap gap-3">
                <a href="tel:+390565200000" class="btn-primary btn-sm">Chiama</a>
