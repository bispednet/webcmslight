            ...
            <div class="info-card">
                ...
                <div class="space-y-3 text-sm" style="color:var(--c-muted)">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="tel:+390565311136" class="hover:underline"><?= htmlspecialchars($phone, ENT_QUOTES, 'UTF-8') ?></a>
                    </div>
                    <div class="flex items-center gap-3">
    ...
    <section class="grid gap-6 md:grid-cols-2 items-center" data-animate>
        ...
        <div class="info-card">
            ...
            <div class="flex flex-wrap gap-3">
                <a href="tel:+390565311136" class="btn-primary btn-sm">Chiama: 0565 31136</a>
