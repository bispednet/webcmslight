...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/ai-concierge.css?v=20260531-natural-handoff">
...
<body class="<?= htmlspecialchars($bodyClass, ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <script src="/assets/js/ai-concierge.js?v=20260531-natural-handoff" defer></script>
